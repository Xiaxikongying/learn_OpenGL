...
{
public:
    SphereGeometry(float radius = 1.0f, float widthSegments = 30.0f, float heightSegments = 30.0f, float phiStart = 0.0f, float phiLength = PI * 2.0f, float thetaStart = 0.0f, float thetaLength = PI)
    {

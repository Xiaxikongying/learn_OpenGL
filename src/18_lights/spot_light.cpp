...
//     // 生成着色器
//     Shader ourShader("./shader/spot/spot_vertex.glsl", "./shader/spot/spot_fragment.glsl");
...
//     ourShader.setFloat("light.cutOff", glm::cos(glm::radians(12.5f)));      // 内切光角
//     ourShader.setFloat("light.outerCutOff", glm::cos(glm::radians(17.5f))); // 外光切角

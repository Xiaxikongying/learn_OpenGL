...
// // 练习二：尝试用不同的纹理环绕方式，设定一个从0.0f到2.0f范围内的（而不是原来的0.0f到1.0f）纹理坐标。
// //        试试看能不能在箱子的角落放置4个笑脸
...
//     Shader ourShader("./shader/vertex_test2.glsl", "./shader/fragment_test2.glsl");
//     // 3顶点数据
//     float vertices[] = {
//         //     ---- 位置 ----       ---- 颜色 ----     - 纹理坐标 -
...
//     // GL_CLAMP_TO_BORDER：需要设置边缘颜色值
//     float borderColor[] = {0.3f, 0.1f, 0.7f, 1.0f};
//     glTexParameterfv(GL_TEXTURE_2D, GL_TEXTURE_BORDER_COLOR, borderColor);
//     glTexParameterf(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_CLAMP_TO_BORDER); // x轴的过滤方式
//     glTexParameterf(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_CLAMP_TO_BORDER); // Y轴
...
//     glTexParameterf(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_MIRRORED_REPEAT); // x轴的环绕方式
//     glTexParameterf(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_MIRRORED_REPEAT); // Y轴的环绕方式
